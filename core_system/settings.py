...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-uzkeyl89rucd-y1p$&a6u@(h1g$pn9abir-=qwhr46t3l2ne@f')
...
INSTALLED_APPS = [
    ...
    'master_brands.apps.MasterBrandsConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'master_products.context_processors.unread_chat_count',
            ],
        },
    },
]
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'volta_db'),
...
LOGIN_REDIRECT_URL = 'master_products:dashboard_redirect'
