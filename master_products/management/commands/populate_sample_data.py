"""
Django Management Command: populate_sample_data
Mengisi database dengan data sampel untuk testing dan demo e-commerce VOLTA
Jalankan dengan: python manage.py populate_sample_data
"""

from django.core.management.base import BaseCommand
from decimal import Decimal
from users.models import User  # Custom User Model
from master_products.models import Brand, Category, Product


class Command(BaseCommand):
    help = 'Populate database dengan data sampel untuk testing VOLTA e-commerce'

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('\n' + '=' * 70))
        self.stdout.write(self.style.SUCCESS('🌟 POPULATE SAMPLE DATA - VOLTA E-Commerce Platform'))
        self.stdout.write(self.style.SUCCESS('=' * 70 + '\n'))

        # =====================================================================
        # 1. CREATE CATEGORIES
        # =====================================================================
        self.stdout.write(self.style.HTTP_INFO('[1] Creating Categories...'))
        ...
        for cat_data in categories_data:
            ...
            self.stdout.write(f"  {status}: {category.category_name}")
        ...
        for brand_data in brands_data:
            ...
            self.stdout.write(f"  {status}: {brand.brand_name} (User: {user.username})")
        ...
        for prod_data in products_data:
            ...
            self.stdout.write(
                ...
                f"           Price: {price_formatted} | Stock: {prod_data['stock']} unit"
            )
        ...
        # =====================================================================
        self.stdout.write(self.style.SUCCESS('\n' + '=' * 70))
        self.stdout.write(self.style.SUCCESS('✓ DATA SAMPEL BERHASIL DIISI KE DATABASE!'))
        self.stdout.write(self.style.SUCCESS('=' * 70))
        
        self.stdout.write(self.style.WARNING('\n📊 Summary:'))
        self.stdout.write(f'   • Categories: {len(categories_data)} kategori')
        self.stdout.write(f'   • Brands: {len(brands_data)} brand/vendor')
        self.stdout.write(f'   • Products: {len(products_data)} produk')
        
        self.stdout.write(self.style.WARNING('\n🌐 URL untuk Testing:'))
        self.stdout.write('   • Homepage: http://localhost:8000/master_products/product_list/')
